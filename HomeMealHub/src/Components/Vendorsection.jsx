...
const Vendorsection = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 sm:px-6 py-12 md:py-16 bg-white text-black">
      ...
      <div className="lg:w-1/2 lg:ml-10 bg-white bg-opacity-10 backdrop-blur-lg p-6 sm:p-9 md:p-10 rounded-xl shadow-2xl max-w-md w-full border border-gray-300 mx-4 sm:mx-2">
        ...
        <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
          ...
          >
            {isLoading ? (
              <TailSpin height="28" width="28" color="#ffffff" radius="1" />
            ) : (
              "Become a Partner"
            )}
          </button>
