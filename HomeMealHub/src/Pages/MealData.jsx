...
const meals = {
	Breakfast: [
		{
			...
			desc:
				"Rolled oats, topped with unsweetened yogurt, blueberries, chia seeds.",
			price: 100,
			img: Oats,
		},
		{
			...
			desc:
				"Whole grain bread, mashed avocado, sliced boiled egg, sprinkle of seeds.",
			price: 150,
			img: Toast,
		},
		{
			title: "Smoothie Bowl",
			desc:
				"Spinach, banana, almond milk, protein powder, topped with nuts and seeds.",
			price: 140,
			img: Smoothie,
		},
		{
	...
	Dinner: [
		...
		},
		{
			...
			desc:
				"Cauliflower rice with sautéed mushrooms, spinach, and a poached egg.",
			price: 200,
			img: CauliflowerRice,
		},
	],
			...
			{cartItems.length > 0 && (
				<div className="fixed bottom-0 left-0 right-0 bg-[#F17228] text-white z-50 px-6 py-3 shadow-[0_-2px_10px_rgba(0,0,0,0.1)] flex items-center justify-between md:justify-center gap-4">
					<div className="flex items-center gap-2 text-sm sm:text-base font-medium">
						<img src="./cooking.png" alt="cart" className="w-6 h-6 sm:w-8 sm:h-8" />
						<span>
